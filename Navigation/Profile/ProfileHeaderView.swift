...
class ProfileHeaderView:UIView{
    ...
    private lazy var avatarImageView: UIImageView = {
        let imageView = UIImageView(frame: CGRect(x: 20, y: 111, width: 170, height: 170))
    ...
    private lazy var textFild: UITextField = {
        let textFild = UITextField(frame: CGRect(x: 218, y: 202, width: 137, height: 60))
    ...
    private lazy var button: UIButton = {
        let button = UIButton(frame: CGRect(x: 20, y: 300, width: 380, height: 50))
